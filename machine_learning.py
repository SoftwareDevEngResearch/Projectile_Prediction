...
cube_X = td.cube[td.cube.columns[2]]

# Split the data into training/testing sets
cube_X_train = cube_X
cube_X_train=np.reshape(cube_X_train(1,-1))
cube_X_test = cube_X[len(cube_X)-5:]

# Split the targets into training/testing sets
cube_y_train = td.velocity_measured
cube_y_test = td.velocity_measured[len(cube_X)-5:]
